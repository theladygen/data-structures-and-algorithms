...
const typeNum = (arr) => {
  // Solution code here...
  let onlyNums = arr.filter(num => typeof num === 'number');
  return onlyNums;
};
...
const containsAnd = (arr) => {
  // Solution code here...
  let stringsWithAnd = arr.filter(string => string.includes ('and'));
  return stringsWithAnd;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let elementsOnlyInSecond = arr.filter (value => !(forbiddenValues.includes(value)));
  return elementsOnlyInSecond;
};
